...
namespace {
struct qt_meta_tag_ZN9TrackInfoE_t {};
} // unnamed namespace

template <> constexpr inline auto TrackInfo::qt_create_metaobjectdata<qt_meta_tag_ZN9TrackInfoE_t>()
{
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        // property 'icon'
        QtMocHelpers::PropertyData<QUrl>(5, QMetaType::QUrl, QMC::DefaultPropertyFlags, 0),
        // property 'index'
    ...
    return QtMocHelpers::metaObjectData<TrackInfo, qt_meta_tag_ZN9TrackInfoE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject TrackInfo::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9TrackInfoE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9TrackInfoE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9TrackInfoE_t>.metaTypes,
    nullptr
} };
...
void TrackInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TrackInfo::*)()>(_a, &TrackInfo::dataChanged, 0))
            return;
    }
...
void *TrackInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9TrackInfoE_t>.strings))
